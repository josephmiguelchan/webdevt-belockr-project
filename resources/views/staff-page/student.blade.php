...
<form action="#" method="POST">
  ...
  <div class="form-group">
      ...
      <input disabled="" type="number" class="form-control" name="student_id" maxlength="8" value="{{$student->student_id}}">
    </div>
       <!-- Grid row -->
    <div class="form-row">
      <!-- Default input -->
      <div class="form-group col-md-4">
        ...
        <input disabled="" type="text" class="form-control" name="first_name" maxlength="50" value="{{$student->first_name}}">
      </div>
      <!-- Default input -->
      <div class="form-group col-md-4">
        <label>Middle name</label>
        <input disabled="" type="text" class="form-control" name="middle_name" maxlength="50" value="{{$student->middle_name}}">
      </div>
      <!-- Default input -->
      <div class="form-group col-md-4">
        <label>Last name</label>
        <input disabled="" type="text" class="form-control" name="last_name" maxlength="50" value="{{$student->last_name}}">
      </div>
    </div>
    <!-- Grid row -->
  ...
  <!-- Default input -->
    <div class="form-group">
      <label>Course</label>
        <select disabled="" required="" name="course" class="form-control">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      <label>Email</label>
      <input type="text" disabled="" class="form-control" name="email" value="{{$student->email}}">
    </div>
    <!-- Default input -->
    <div class="form-group col-md-6">
     <label>Year Level</label>
        <select disabled="" required="" name="year_level" class="form-control">
