...
<body>
    ...
    <form class="p-5">
        ...
        <p class="text-center h4 text-danger">Application Denied</p>
    
        <p class="text-center mb-4">Upon review of your reservation status, you are not eligible for locker rental reservation this term. Please email us if you think there has been a mistake.</p>
