...
<body>
    ...
    <form class="p-5">
        ...
        <p class="text-center h4 text-success">Locker Reserved!</p>
    
        <p class="text-center mb-4">Thank you for choosing Belockr. You may now use your locker for one (1) term only. Please be reminded to vacate your belongings before the end of semester.</p>
