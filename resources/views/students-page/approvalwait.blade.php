...
<body>
    ...
    <mdb-navbar SideClass="navbar navbar-dark indigo">
      ...
      <div class="collapse navbar-collapse" id="basicExampleNav">
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link">
              3. Wait for LSO's approval and payment instruction
            </a>
          </li>
        </ul>
    ...
    <form class="p-5">
        ...
        <p class="text-center mb-4">You have reserved a locker successfully. Please wait for the LSO to approve your reservation.</p>
